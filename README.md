...
В папке находится два файла с расширением .py, где **solution.py - это решение тестового задания**, test.py был создан для упрощения тестирования решения в ходе разработки
